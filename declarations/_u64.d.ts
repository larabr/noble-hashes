...
export declare function fromBig(n: BigInteger, le?: boolean): {
    h: number;
    l: number;
};
export declare function split(lst: BigInteger[], le?: boolean): Uint32Array[];
export declare const toBig: (h: number, l: number) => BigInteger;
...
declare const u64: {
    ...
    split: typeof split;
    toBig: (h: number, l: number) => BigInteger;
